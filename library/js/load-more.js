jQuery(function($){
	$('.load-more-button > a.button.load-more').click(function(){
		...
		$.ajax({
			...
			beforeSend : function ( xhr ) {
				button.html('<i class="fas fa-circle-notch fa-pulse"></i>'); // change the button text, you can also add a preloader image
			},
			success : function( data ){
				if( data ) { 
					button.html( 'Load More' ).parent().siblings('.main-loop').append(data); // insert new posts
	...
	$('.load-more-button > a.button.clear-search').click(function(){
